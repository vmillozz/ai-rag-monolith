...
import { ShieldCheck, Database, Brain, FileText, LogOut } from "lucide-react";
      ...
      <header className="border-b border-slate-800 backdrop-blur bg-slate-950/90 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-cyan-500 flex items-center justify-center font-black text-sm">
              RAG
            </div>
            <div>
              <h1 className="text-lg font-bold leading-tight">Smart Enterprise Search</h1>
              <p className="text-slate-500 text-xs">Local AI · RAG Platform</p>
            </div>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-16">
          {[
            ...
            <div key={label} className="flex items-center gap-2 bg-slate-900 border border-slate-800 rounded-full px-4 py-2 text-sm text-slate-300">
        ...
        <div className="grid lg:grid-cols-5 gap-6 text-left">
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
              <h3 className="font-semibold text-sm text-slate-400 uppercase tracking-wider mb-4">Come funziona</h3>
